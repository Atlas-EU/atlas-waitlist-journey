      ...
      <div className="container mx-auto px-6">
        <div className="flex flex-col md:flex-row justify-between items-center">
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 gap-x-12 gap-y-6 text-sm">
            ...
            <div>
              ...
              <ul className="space-y-2">
                <li><a href="/privacy-policy" className="text-atlas-gray-light hover:text-atlas-green-strong transition-colors">Privacy Policy</a></li>
                <li><a href="/terms-and-conditions" className="text-atlas-gray-light hover:text-atlas-green-strong transition-colors">Terms of Service</a></li>
              </ul>
            </div>
        ...
        <div className="mt-12 pt-6 border-t border-atlas-gray-unselected/20 flex flex-col md:flex-row justify-between items-center">
          ...
          <div className="flex space-x-6">
            <a href="#" className="text-atlas-gray-light hover:text-atlas-green-strong transition-colors">
